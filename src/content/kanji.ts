...
export const kanjiItems: KanjiItem[] = [
  ...
  // Appointments — W4D1
  { id: "k-yaku", kanji: "約", reading: "やく", meaning: "promise / approx. / contract", compounds: ["予約", "約束", "契約"], category: "Schedules", week: 13 },
  ...
  { id: "k-shu", kanji: "取", reading: "しゅ", meaning: "take / obtain", compounds: ["取引", "取得"], category: "Companies / People", week: 7 },
  { id: "k-in3", kanji: "引", reading: "いん", meaning: "pull / withdraw", compounds: ["取引", "割引"], category: "Companies / People", week: 7 },
  { id: "k-sama", kanji: "様", reading: "さま", meaning: "honorific suffix / manner", compounds: ["お客様", "様子"], category: "Companies / People", week: 7 },
  { id: "k-chou", kanji: "長", reading: "ちょう", meaning: "long / chief", compounds: ["部長", "社長"], category: "Companies / People", week: 3 },
  { id: "k-ka4", kanji: "下", reading: "か", meaning: "below / subordinate", compounds: ["部下", "以下"], category: "Companies / People", week: 3 },
  { id: "k-jou", kanji: "上", reading: "じょう", meaning: "above / superior", compounds: ["上司", "以上"], category: "Companies / People", week: 3 },
  { id: "k-shi2", kanji: "司", reading: "し", meaning: "administer", compounds: ["上司"], category: "Companies / People", week: 3 },
  { id: "k-sen2", kanji: "先", reading: "せん", meaning: "ahead / previous", compounds: ["先方", "先週"], category: "Companies / People", week: 7 },
  { id: "k-hou3", kanji: "方", reading: "ほう", meaning: "direction / person", compounds: ["先方", "方針"], category: "Companies / People", week: 7 },
  { id: "k-shi3", kanji: "資", reading: "し", meaning: "resources / capital", compounds: ["資料", "資金"], category: "Documents", week: 5 },
  { id: "k-kaku2", kanji: "格", reading: "かく", meaning: "status / standard", compounds: ["価格", "資格"], category: "Money", week: 17 },
  { id: "k-hin", kanji: "品", reading: "ひん", meaning: "goods / quality", compounds: ["商品", "品質"], category: "Sales", week: 12 },
  { id: "k-shou2", kanji: "商", reading: "しょう", meaning: "commerce", compounds: ["商品", "商談"], category: "Sales", week: 12 },
  { id: "k-zai", kanji: "在", reading: "ざい", meaning: "exist / stock", compounds: ["在庫", "不在"], category: "Sales", week: 12 },
  { id: "k-ko", kanji: "庫", reading: "こ", meaning: "warehouse", compounds: ["在庫", "倉庫"], category: "Sales", week: 12 },
  { id: "k-nou", kanji: "納", reading: "のう", meaning: "deliver / pay in", compounds: ["納品", "納期"], category: "Delivery", week: 12 },
  { id: "k-ki", kanji: "期", reading: "き", meaning: "period / term", compounds: ["期限", "納期"], category: "Schedules", week: 6 },
  { id: "k-gen3", kanji: "限", reading: "げん", meaning: "limit", compounds: ["期限", "制限"], category: "Schedules", week: 6 },
  { id: "k-hen", kanji: "変", reading: "へん", meaning: "change / strange", compounds: ["変更", "大変"], category: "Schedules", week: 6 },
  { id: "k-kou2", kanji: "更", reading: "こう", meaning: "renew / further", compounds: ["変更", "更新"], category: "Schedules", week: 6 },
  { id: "k-san", kanji: "参", reading: "さん", meaning: "participate / humble go", compounds: ["参加", "参考"], category: "Meetings", week: 4 },
  { id: "k-ka5", kanji: "加", reading: "か", meaning: "add", compounds: ["参加", "追加"], category: "Meetings", week: 4 },
  { id: "k-seki", kanji: "席", reading: "せき", meaning: "seat", compounds: ["出席", "座席"], category: "Meetings", week: 4 },
  { id: "k-ketsu2", kanji: "欠", reading: "けつ", meaning: "lack / absent", compounds: ["欠席", "欠品"], category: "Meetings", week: 4 },
  { id: "k-kai2", kanji: "開", reading: "かい", meaning: "open / start", compounds: ["開始", "開催"], category: "Schedules", week: 6 },
  { id: "k-shi4", kanji: "始", reading: "し", meaning: "begin", compounds: ["開始"], category: "Schedules", week: 6 },
  { id: "k-shuu2", kanji: "終", reading: "しゅう", meaning: "end", compounds: ["終了", "最終"], category: "Schedules", week: 6 },
  { id: "k-ryou3", kanji: "了", reading: "りょう", meaning: "finish / understand", compounds: ["終了", "完了"], category: "Schedules", week: 6 },
  { id: "k-jou2", kanji: "場", reading: "じょう", meaning: "place / venue", compounds: ["会場", "工場"], category: "Schedules", week: 6 },
  { id: "k-sho2", kanji: "所", reading: "しょ", meaning: "place", compounds: ["場所", "事務所"], category: "Schedules", week: 6 },
  { id: "k-ren", kanji: "連", reading: "れん", meaning: "connect", compounds: ["連絡", "関連"], category: "Instructions", week: 6 },
  { id: "k-raku", kanji: "絡", reading: "らく", meaning: "entwine / contact", compounds: ["連絡"], category: "Instructions", week: 6 },
  { id: "k-sou", kanji: "相", reading: "そう", meaning: "mutual / consult", compounds: ["相談", "相手"], category: "Instructions", week: 8 },
  { id: "k-dan", kanji: "談", reading: "だん", meaning: "talk / discuss", compounds: ["相談", "商談"], category: "Instructions", week: 8 },
  { id: "k-shou3", kanji: "承", reading: "しょう", meaning: "consent / receive", compounds: ["承認", "承知"], category: "Instructions", week: 8 },
  { id: "k-bun", kanji: "文", reading: "ぶん", meaning: "sentence / writing", compounds: ["注文", "文書"], category: "Documents", week: 9 },
  { id: "k-tei2", kanji: "提", reading: "てい", meaning: "present / propose", compounds: ["提出", "提案"], category: "Documents", week: 5 },
  { id: "k-an", kanji: "案", reading: "あん", meaning: "plan / proposal", compounds: ["提案", "案内"], category: "Meetings", week: 14 },
  { id: "k-ken2", kanji: "検", reading: "けん", meaning: "examine", compounds: ["検討", "検品"], category: "Meetings", week: 14 },
  { id: "k-tou", kanji: "討", reading: "とう", meaning: "discuss / examine", compounds: ["検討"], category: "Meetings", week: 14 },
  { id: "k-jitsu", kanji: "実", reading: "じつ", meaning: "truth / actual", compounds: ["実施", "実績"], category: "Instructions", week: 16 },
  { id: "k-shi5", kanji: "施", reading: "し", meaning: "carry out", compounds: ["実施", "施設"], category: "Instructions", week: 16 },
  { id: "k-ei", kanji: "営", reading: "えい", meaning: "manage / operate", compounds: ["営業", "経営"], category: "Sales", week: 12 },
  { id: "k-gyou", kanji: "業", reading: "ぎょう", meaning: "business / work", compounds: ["営業", "業務"], category: "Sales", week: 12 },
  { id: "k-bai", kanji: "売", reading: "ばい", meaning: "sell", compounds: ["売上", "販売"], category: "Sales", week: 12 },
  { id: "k-you", kanji: "用", reading: "よう", meaning: "use / business", compounds: ["使用", "用件"], category: "Instructions", week: 9 },
];
