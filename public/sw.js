const CACHE_VERSION = "bjt-quest-v1";
...
self.addEventListener("fetch", (event) => {
  ...
  // Navigations: network-first so content stays fresh, fall back to cache when offline.
  ...
  // Static assets (_next/static, icons, fonts): cache-first, since they're content-hashed.
